...
<link href="{{asset('frontend/css/item.css')}}" rel="stylesheet">
<link href="{{asset('frontend/css/gamecard.css')}}" rel="stylesheet">
...
<link href="{{asset('frontend/css/cartnav.css')}}" rel="stylesheet">
