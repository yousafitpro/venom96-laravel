...
<div class="maintop2 container-fluid" id="navbar">
    <div class="inner" >
        ...
        <div id="user_nav">
                <a href="https://member.seagm.com/sso/login?origin=https%3A%2F%2Fwww.kaleoz.com%2F&amp;_ts=1646179790.2349" class="signin"><span icon="person_add"><i class="fa fa-user-plus"></i> Login / Sign-Up</span></a>
        </div>
        <div id="mb_user_nav">
