...
<div class="maintop2 fixed-top container-fluid">
    <div class="inner" >
        ...
        <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
            <div id="header_logo1">
             ...
             <div class="links">
                <a href="#" style="color: black; font-size: 15px; font-weight: bold">KALEOZ Steam Market</a>
        ...
        <div id="top_nav_on" class="nav_ctrl" onclick="openNav()"><i class="fa fa-bars fa-lg"></i></div>
        <div id="header_logo">
                <a href="https://www.kaleoz.com/">
                    <svg id="KALEOZ-LOGO" viewBox="0,0 96,20" width="96" height="20">
                        <path id="KALEOZ-LOGO-TEXT" fill="dodgerblue" d="M40.103,15.238V0.952h-4.801V15.97l1.24,3.077h10.28l-1.68-3.809H40.103z M26.892,0.953h-5.223l-6.015,16.077L9.489,9.469l7.315-8.517h-6.271L4.814,8.19V0.952H0.018v18.095h4.797V11.31l6.244,7.737h3.841h5.208l1.057-3.338h6.248l1.075,3.338h5.695L26.892,0.953L26.892,0.953z M22.451,12.386l1.818-5.239l1.847,5.241L22.451,12.386z M95.982,0.952H78.986l2.967,3.81h6.213l-8.877,14.285h15.779v-3.809h-7.699L95.982,0.952z M52.574,15.25v-3.346h5.523V8.104h-5.523V4.762h7.014l-1.535-3.81h-10.27v14.762l1.344,3.333h12.414l-2.475-3.797H52.574zM70.586,0c-5.568,0-10.082,4.478-10.082,9.999C60.504,15.521,65.018,20,70.586,20c5.566,0,10.082-4.479,10.082-10.001C80.668,4.478,76.152,0,70.586,0z M70.586,15.952c-3.314,0-6.002-2.663-6.002-5.952c0-3.288,2.688-5.953,6.002-5.953c3.312,0,6,2.665,6,5.953C76.586,13.289,73.898,15.952,70.586,15.952z"></path>
        ...
        <div id="mb_user_nav">
                <a href="https://member.seagm.com/sso/login?origin=https%3A%2F%2Fwww.kaleoz.com%2F&amp;_ts=1646179790.2349" class="signin"><span icon="person_add"><i class="icon fa fa-circle-user"></i></span></a>
        </div>
        <ul id="ucp_list">
            <li class="l_item_1 dropdown">
                <a class=" bt user " type="button" id="dropdownMenuButton" data-toggle="dropdown">
                    <i class="icon fa fa-circle-user"></i>
                    <span class="user_name" icon="account_circle">Miss_Silly</span>
                </a>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <p class="des">
                        User Control Panel
                    </p>
                    <a class="dropdown-item" href="#"><i class="icon fa fa-gear"></i>Control Panel</a>
                    <a class="dropdown-item" href="#"><i class="icon fa fa-circle-user"></i>My Profile</a>
                    <a class="dropdown-item" href="#"><i class="icon fa fa-list"></i>My Orders</a>
                    <a class="dropdown-item" href="#"><i class="icon fa fa-bank"></i>My Account</a>
                    <a class="dropdown-item" href="#"><i class="icon fa fa-bell"></i>Notifications</a>
                    <a class="dropdown-item" href="#"><i class="icon fa fa-envelope"></i>Support Message</a>
                    <a class="dropdown-item" href="#"><i class="icon fa fa-sign-out"></i>Sign Out</a>
                </div>
            </li>
            <li class="l_item_2">
                <a href="https://www.kaleoz.com/notification" class="notification" msg-counter="0">
                   <i class="icon fa fa-bell"></i>
               </a>
            </li>
            <li>
                   <a href="https://member.seagm.com/sso/login?origin=https%3A%2F%2Fwww.kaleoz.com%2F&amp;_ts=1646179790.2349" class="signin">
                        <span icon="person_add">
                        <i class=" icon fa fa_cart" style="font-size:24px">&#xf07a;</i>
                        <span class=' icon badge badge-warning' id='lblCartCount'> 5 </span>
                        </span>
                    </a>
            </li>
        </ul>
